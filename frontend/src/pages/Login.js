    ...
    <div className="flex items-center justify-center min-h-screen min-w-full bg-bgdark">
      <div className="h-96 w-96 rounded-xl bg-purple flex flex-col items-center justify-center">
        <div className="flex flex-row mb-5">
          ...
          <AiOutlineLogin size={30} color='bgdark' />
          </div>
      ...
      <div className="rounded-full mt-2">
          <div className="flex border-none text-sm  text-black bg-white outline-none px-3 pb-3 pt-2 rounded-2xl">
            <div className="flex flex-col ">
              <div className=" text-[#979797] text-[12px]">Username</div>
              <input
                type="text"
        ...
        <div className="rounded-full mt-4">
          <div className="flex border-none text-sm  text-black bg-white outline-none px-3 pb-3 pt-2 rounded-2xl">
            <div className="flex flex-col ">
              <div className=" text-[#979797] text-[12px]">Password</div>
              <input
        ...
        <div className="mt-4">
          <button className=" bg-white  hover:bg-purple duration-200 hover:text-white px-4 py-2 rounded-2xl text-[16px]">
            LOGIN
          </button>
        </div>
      </div>
