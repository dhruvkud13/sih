...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen min-w-full bg-bgdark font-raleway">
      <div className="h-[32rem] w-[32rem] rounded-xl bg-purple flex flex-col items-center justify-center">
        <div className="flex flex-row mb-5">
          <div className="flex justify-center items-center pr-2">
            <AiOutlineLogin size={30} color="#202124" />
          </div>
          <div className=" font-semibold text-bgdark text-[30px]">signup</div>
        </div>
        <div className="rounded-full mt-2">
          <div className="flex border-none text-sm  text-black bg-white outline-none px-3 pb-3 pt-2 rounded-2xl ">
            <div className="flex flex-col ">
              ...
              <input
                type="text"
                className="text-black relative  border-none bg-transparent outline-none w-[16rem]"
              />
            </div>
        ...
        <div className="mt-4">
          <button className=" bg-white  hover:bg-purple duration-200 hover:text-white px-6 py-2 rounded-2xl text-[18px] font-semibold">
            SIGNUP
          </button>
        </div>
      </div>
